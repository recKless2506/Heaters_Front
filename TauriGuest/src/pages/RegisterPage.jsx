...
import { registerUserHeaters } from "../slices/authSlice";
...
export function RegisterPage() {
  ...
  const handleSubmit = async (e) => {
    ...
    const action = await dispatch(registerUserHeaters({ login, password }));
    if (registerUserHeaters.fulfilled.match(action)) {
      navigate("/heaters-login");
    }
  };
      ...
      >
        <div style={{ marginBottom: 20 }}>
          ...
          <p style={{ margin: 0, fontSize: 14, color: "#6b7280" }}>
            Укажите логин и пароль, чтобы начать работу с сервисом.
          </p>
        </div>
